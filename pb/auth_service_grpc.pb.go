...
type AuthServiceClient interface {
	SignUpUser(ctx context.Context, in *SignUpUserInput, opts ...grpc.CallOption) (*GenericResponce, error)
	VerifyEmail(ctx context.Context, in *VerifyEmailRequest, opts ...grpc.CallOption) (*GenericResponce, error)
...
func (c *authServiceClient) SignUpUser(ctx context.Context, in *SignUpUserInput, opts ...grpc.CallOption) (*GenericResponce, error) {
	out := new(GenericResponce)
...
func (c *authServiceClient) VerifyEmail(ctx context.Context, in *VerifyEmailRequest, opts ...grpc.CallOption) (*GenericResponce, error) {
	out := new(GenericResponce)
...
type AuthServiceServer interface {
	SignUpUser(context.Context, *SignUpUserInput) (*GenericResponce, error)
	VerifyEmail(context.Context, *VerifyEmailRequest) (*GenericResponce, error)
...
func (UnimplementedAuthServiceServer) SignUpUser(context.Context, *SignUpUserInput) (*GenericResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignUpUser not implemented")
}
func (UnimplementedAuthServiceServer) VerifyEmail(context.Context, *VerifyEmailRequest) (*GenericResponce, error) {
